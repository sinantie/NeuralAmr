...
public class AmrUtils {    
    ...
    private enum Action {ANONYMIZE_AMR, DEANONYMIZE_AMR, ANONYMIZE_TEXT, DEANONYMIZE_TEXT};
    ...
    private void initDictionaries(Action action) {
        switch(action) {
            case ANONYMIZE_AMR: dictionaries = new Dictionaries(settings, false, "amr", true); break;
            case DEANONYMIZE_AMR: dictionaries = new Dictionaries(settings, false, "amr", false); break;
            case ANONYMIZE_TEXT: dictionaries = new Dictionaries(settings, false, "anonymize", false); break;
        }
    }
...
//                                deAnonymizeSingle(l, false)).split("#")[0] ));
    ...
    private List<String> processName(String node, boolean encloseInBrackets, Map<String, AnonymizationAlignment> map) {
        ...
        if(encloseInBrackets)
            out.add("("); 
        out.add(headNode); out.add(":name"); out.add("("); out.add("name");
    ...
    public static void main(String[] args) {
        ...
        Action action = null;
        switch(args[0]) {
            case "anonymizeAmrStripped" : strippedAmr = true; action = Action.ANONYMIZE_AMR; break;
            case "anonymizeAmrFull" : strippedAmr = false; action = Action.ANONYMIZE_AMR; break;
            case "deAnonymizeText" : action = Action.DEANONYMIZE_TEXT; break;
            case "anonymizeText" : action = Action.ANONYMIZE_TEXT; break;
            case "deAnonymizeAmr" : action = Action.DEANONYMIZE_AMR; break;
        ...
        switch(action) {
            case ANONYMIZE_AMR: System.out.println(agas.anonymizeAmr(input, strippedAmr, inputIsFile)); break;
            case DEANONYMIZE_AMR: System.out.println(agas.deAnonymizeAmr(input, inputIsFile)); break; 
            case ANONYMIZE_TEXT: System.out.println(agas.anonymizeText(input, inputIsFile)); break;
            case DEANONYMIZE_TEXT: System.out.println(agas.deAnonymizeText(input, inputIsFile)); break;
        }                
    }          
}
